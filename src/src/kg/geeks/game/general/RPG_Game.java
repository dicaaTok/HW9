package src.kg.geeks.game.general;

import src.kg.geeks.game.players.*;
...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(1000, 30, "Saruman");
        ...
        Ludoman bro = new Ludoman(300, 20, "bro");
        Hero[] heroes = {warrior1, doc, magic, warrior2, berserk, assistant, bro};
